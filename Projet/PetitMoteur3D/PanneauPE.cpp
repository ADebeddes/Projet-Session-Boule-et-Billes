...
namespace PM3D
{
	...
	void CPanneauPE::Draw()
	{
		...
		// Choix de la technique : TODO use somme of technique
		pTechnique = pEffet->GetTechniqueByIndex(TECHNIQUE_USED);
		pPasse = pTechnique->GetPassByIndex(0);

		// input layout des sommets
		pImmediateContext->IASetInputLayout(pVertexLayout[TECHNIQUE_USED]);
